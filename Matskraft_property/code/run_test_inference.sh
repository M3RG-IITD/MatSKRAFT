...
time python -u test_inferencing.py --seeds 2 --alphas 0.75 --hidden_layer_sizes 2048 1024 --num_heads 4 4 --lr 5e-5 --lm_lr 1e-5  --add_constraint --use_caption --c_loss_lambda 50.0 --model_variant $model_variant --res_file $res_file >> $out_file 2>> $err_file
