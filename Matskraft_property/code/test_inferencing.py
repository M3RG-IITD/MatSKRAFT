...
# for split in ['infer']:
#     datasets['infer'] = TableDataset([comp_data_dict[k] for k in comp_keys])
...
print('\nInference\n')
for split in ['infer']: #['train', 'val', 'test']:
...
if args.res_file:
    ...
    pickle.dump(res, open(os.path.join(table_dir,'res_dir_without_threshold',f'matskraft_property.pkl') , 'wb'))
